        ...
        <div className="mt-7 lg:mt-8 xl:mt-10 flex flex-col gap-6 w-full lg:w-[60%]">
          {currentData.map((data, index) => (
            <button
              ...
              className={`heading2 !font-medium flex items-center justify-between p-3 border rounded-tr-lg rounded-br-lg transition-all duration-300 ${selectedItem.item === data.item
